...
<?php
  include_once 'partials/form_modal.php';
  include_once 'partials/profile_modal.php';
?>
...
<div class="row mb-3">
<div class="col-3">
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#userModal" id="addnewbutton">Add New <i class="fa fa-user-circle-o" ></i></button>
</div>
<div class="col-9">
